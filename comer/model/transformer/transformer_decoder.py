...
class TransformerDecoderLayer(nn.Module):
    def __init__(self, d_model, nhead, dim_feedforward=2048,MHA_dropout = 0,FFN_dropout = 0):
        super(TransformerDecoderLayer, self).__init__()
        self.self_attn = MultiheadAttention(d_model, nhead, dropout=MHA_dropout)
        self.multihead_attn = MultiheadAttention(d_model, nhead, dropout=MHA_dropout)
